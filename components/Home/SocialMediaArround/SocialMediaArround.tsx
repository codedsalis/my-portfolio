  ...
  return (
    ...
    >
      <a href={props.href} className="" target={"_blank"} rel="noreferrer">
        <props.Icon
          className={
            "w-6 h-6 text-gray-400 hover:text-blue fill-current hover:cursor-pointer"
          }
        />
      </a>
    </motion.div>
    ...
    <>
      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            ...
            <IconClickableWithAnimation
              Icon={TwitterIcon}
              href={"https://twitter.com/codedsalis"}
            />
            {/* Linkedin icon */}
            <IconClickableWithAnimation
              Icon={LinkedinIcon}
      ...
      >
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          >
            <a
              href="mailto:talitu6@gmail.com"
              target={"_blank"}
              rel="noreferrer"
            >
              <span className=" font-Header tracking-wide text-gray-400 hover:text-blue hover:cursor-pointer">
                talitu6@gmail.com
              </span>
            </a>
          </motion.div>
