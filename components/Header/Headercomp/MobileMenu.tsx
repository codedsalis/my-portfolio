    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <span className="text-blue text-xs font-mono">01.</span>
            <span
          ...
          <Link
            ...
            className="flex flex-col text-center space-y-2"
          >
            <span className="text-blue text-xs font-mono hover:cursor-pointer">02.</span>
            <span
              className="text-white font-Text2 text-sm sm:text-base
             hover:text-blue hover:cursor-pointer duration-300"
            >
          ...
          <Link
            ...
            className="flex flex-col text-center space-y-2"
          >
            <span className="text-blue text-xs font-mono">03.</span>
            <span
              className="text-white font-Text2 text-sm sm:text-base
             hover:text-blue hover:cursor-pointer duration-300"
            >
          ...
          <Link
            ...
            className="flex flex-col text-center space-y-2"
          >
            <span className="text-blue text-xs font-mono">04.</span>
            <span
              className="text-white font-Text2 text-sm sm:text-base
             hover:text-blue hover:cursor-pointer duration-300"
            >
          ...
          <a href={"/resume.pdf"} target={"_blank"} rel="noreferrer">
            <button
              className="rounded border font-Text2  border-blue
           hover:bg-ResumeButtonHover py-2 sm:py-4 px-5 sm:px-10 text-xs text-blue"
            >
              Resume
            </button>
          </a>
