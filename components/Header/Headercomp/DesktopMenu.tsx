    ...
    <div className="font-mono text-xs md:flex hidden flex-row items-center space-x-8 ">
      ...
      >
        <ReactScrollLink to="aboutSection" spy={true} smooth={true} offset={-100} duration={200}>
          &gt; 01. <span className="text-white hover:cursor-pointer hover:text-blue duration-300">About</span>
        </ReactScrollLink>
      </motion.div>
      <motion.div
        initial={{
      ...
      >
        <ReactScrollLink to="WhereIhaveWorkedSection" spy={true} smooth={true} offset={-300} duration={200}>
          &gt; 02.{" "}
          <span className="text-white  hover:cursor-pointer hover:text-blue duration-300">Experience</span>
        </ReactScrollLink>
      </motion.div>
      <motion.div
        initial={{
      ...
      >
        ...
        &gt; 03. <span className="text-white  hover:cursor-pointer hover:text-blue duration-300">Work</span>
      ...
      >
         ...
         &gt; 04. <span className="text-white  hover:cursor-pointer hover:text-blue duration-300">Contact</span>
        </ReactScrollLink>
      </motion.span>
      ...
      <motion.button
        ...
        className="text-blue border border-spacing-2 py-2 px-3 rounded-sm border-blue hover:bg-ResumeButtonHover"
      >
        Resume
      </motion.button>
      </a>
