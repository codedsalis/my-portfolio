...
export default function Home() {
  ...
  const meta = {
    title: "Kadiri Talitu Igbadume - Software Engineer",
    description: `I've been working on Software development for 7 years straight. Get in touch with me to know more.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:site" content="@codedsalis" />
